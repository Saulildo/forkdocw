...
if not game.Players.LocalPlayer.Character then warn("Please spawn in before executing") return end
if _G.ShIn then warn("You're already executed!") return end _G.ShIn = true
...
local SetThread = set_thread_identity
